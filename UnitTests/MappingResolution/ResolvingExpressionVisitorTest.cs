...
namespace Remotion.Linq.SqlBackend.UnitTests.MappingResolution
{
  ...
  public class ResolvingExpressionVisitorTest
  {
    ...
    public void VisitUnresolvedJoinConditionExpression_ResolvesConditionAndRevisitsResult ()
    {
      ...
      _resolverMock
          .Expect (mock => mock.ResolveJoinCondition (originatingEntity, memberInfo, tableInfo))
    ...
    public void VisitUnresolvedCollectionJoinConditionExpression_ObtainsOriginatingEntityAndResolvesConditionAndRevisitsResult ()
    {
      ...
      var result = _visitor.VisitExpression (unresolvedCollectionJoinConditionExpression);
